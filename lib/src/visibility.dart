...
VisibilityState isItemVisible(BuildContext context) {
  ...
  final offsetToRevealTop = itemViewport.getOffsetToReveal(renderObject, 0).offset;
  final offsetToRevealBottom = itemViewport.getOffsetToReveal(renderObject, 0.96).offset;
